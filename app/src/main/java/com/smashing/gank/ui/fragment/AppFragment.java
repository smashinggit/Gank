...
import com.smashing.gank.mvp.presenter.AppPresenter;
...
public class AppFragment extends BaseFragment implements CommonContact.View {
    ...
    public AppFragment(Context mContext) {
        super(mContext);
    }
