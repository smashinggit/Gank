...
import com.smashing.gank.mvp.presenter.ResourcePresenter;
...
public class ResourceFragment extends BaseFragment implements CommonContact.View {
    ...
    public ResourceFragment(Context mContext) {
        super(mContext);
    }
    ...
    @Override
    protected void init() {
        mPresenter = new ResourcePresenter(this);
        mPresenter.getData();
